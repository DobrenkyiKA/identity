...
//            Set<Role> roles = new HashSet<>(existing.roles());
//            roles.add(role);
...
//            log.info("[DataInitializer] Promoted existing user [{}] to role [{}]", existing.email(), role);
//        } else {
//            log.info("[DataInitializer] User already exists: [{}]", existing.email());
//        }
//    }
//}
